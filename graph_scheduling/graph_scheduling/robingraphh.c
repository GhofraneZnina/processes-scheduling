...
typedef struct {
    ...
    GtkWidget *fifo_button;
    GtkWidget *round_robin_button;
    GtkWidget *priority_button;
    GtkWidget *multilevel_button;
    GtkWidget *srtf_button;
    Process *processes;
    int num_processes;
    gboolean chart_drawn;
...
static gboolean on_draw_event(GtkWidget *widget, cairo_t *cr, gpointer user_data) {
    ...
    cairo_show_text(cr, "Round Robin Gantt Chart");
...
int main(int argc, char *argv[]) {
    ...
    gtk_window_set_title(GTK_WINDOW(data.window), "Round Robin Gantt Chart");
